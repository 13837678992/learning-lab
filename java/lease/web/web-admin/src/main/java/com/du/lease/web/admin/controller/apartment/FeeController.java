...
import com.du.lease.web.admin.service.FeeValueService;
...
public class FeeController {
    ...
    public Result deleteFeeKeyById(@RequestParam Long feeKeyId) {
        ...
        LambdaQueryWrapper<FeeValue> feeKeyLambdaQueryWrapper = new LambdaQueryWrapper<FeeValue>().eq(FeeValue::getFeeKeyId, feeKeyId);
